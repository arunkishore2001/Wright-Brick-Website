...
<head>
  <title>Wright Brick - About Us</title>
  <!-- Required meta tags -->
  <meta charset="utf-8" />
  ...
  <main>
        ...
        <div class="col-md-6" data-animation="slideInLeft">
          <div class="right-about">
            <div class="right-about-heading mt-2 mb-5">
              <h2>
                Why We Comes First in <br />
                Your Mind
              </h2>
            </div>

            <div class="right-about-para">
              <p>
                A leading interior design firm offering End-to-End Tech
                enabled services, delivering exceptional luxury interiors with
                a focus on precision and innovation. From concept to
                completion, we ensure unparalleled quality and style. We also
                offer comprehensive construction and architectural design
                services.
              </p>
            </div>
          </div>
    ...
    <div class="container-fluid-max rolling-text my-5" data-animation="flipInY">
      <div class="wrapper">
        ...
        </ul>="tab">TECH INTEGRATED</li>
        </ul>
      </div>
    </div>

    <div class="container-fluid-max">
      <div class="mission-title" data-animation="slideInRight" data-animation-delay="600ms">
        <h5>MISSION</h5>
      </div>
      <div class="container">
          ...
          <div class="col-md-6 mt-0" data-animation="slideInLeft" data-animation-delay="200ms">
            <div class="mission-description">
              ...
              <p>
                ...
                enabled services, delivering exceptional luxury interiors with
                a focus on precision and innovation. From concept to
                completion, we ensure unparalleled quality and style.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid-max vision mt-5">
      <div class="mission-title vision-title" data-animation="slideInLeft" data-animation-delay="600ms">
        <h5>VISION</h5>
      </div>
      <div class="container">
        <div class="row mission-row align-items-center">
        ...
        <div class="middle-content my-5" data-animation="slideInDown" data-animation-delay="500ms">
          <div class="dream-heading">
            <h4>
              ...
              <br />
              We Can <span class="dream-color">Build</span> It
            </h4>
          </div>
          ...
          <div class="dream-para my-1" data-animation="slideInDown" data-animation-delay="800ms">
            <p>
              ...
              on precision and innovation. From concept to completion, we...
            </p>
          </div>
